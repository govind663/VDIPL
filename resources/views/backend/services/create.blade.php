                                ...
                                <div class="pd-20 card-box mb-30">
                                    ...
                                    <div class="form-group row mt-3">
                                        ...
                                        <div class="col-sm-4 col-md-4">
                                            <input type="text" name="service_name" id="service_name" class="form-control @error('service_name') is-invalid @enderror" value="{{ old('service_name') }}" placeholder="Enter Service Name.">
                                            @error('service_name')
                                        ...
                                        <div class="col-sm-4 col-md-4">
                                            <input type="text" readonly name="slug" id="slug" class="form-control @error('slug') is-invalid @enderror" value="{{ old('slug') }}" placeholder="Enter Service Slug.">
                                            @error('slug')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group row mt-3">
                                        ...
                                        <div class="col-sm-4 col-md-4">
                                            <input type="file" onchange="serviceImagePreviewFile()" accept=".png, .jpg, .jpeg, .webp" name="service_image" id="service_image" class="form-control @error('service_image') is-invalid @enderror" value="{{ old('service_image') }}" placeholder="Upload Image.">
                                        ...
                                        <div class="col-sm-4 col-md-4">
                                            <input type="file" onchange="serviceIconPreviewFile()" accept=".png, .jpg, .jpeg, .webp" name="service_icon" id="service_icon" class="form-control @error('service_icon') is-invalid @enderror" value="{{ old('service_icon') }}" placeholder="Upload Service Icon.">
                                            <small class="text-secondary"><b>Note : The file size  should be less than 2MB .</b></small>
                                            <br>
                                            <small class="text-secondary"><b>Note : Only files in .jpg, .jpeg, .png, .webp format can be uploaded .</b></small>
                                            <br>
