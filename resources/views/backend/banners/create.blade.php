                            ...
                            <form method="POST" action="{{ route('banner.store') }}" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="pd-20 card-box mb-30">
                                    ...
                                    <div class="form-group row mt-3">
                                        ...
                                        <div class="col-sm-4 col-md-4">
                                            <input type="text" name="banner_title" id="banner_title" class="form-control @error('banner_title') is-invalid @enderror" value="{{ old('banner_title') }}" placeholder="Enter Banner Title.">
                                            @error('banner_title')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="form-group row mt-3">
                                        <label class="col-sm-2"><b>Banner Title : <span class="text-danger">*</span></b></label>
                                        <div class="col-sm-4 col-md-4">
                                            <input type="text" name="banner_subtitle" id="banner_subtitle" class="form-control @error('banner_subtitle') is-invalid @enderror" value="{{ old('banner_subtitle') }}" placeholder="Enter Banner Title.">
