...
@section('title')
    J4C Group | Add About Statistics
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Add About Statistics</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body add-post">
                            <form method="POST" action="{{ route('about-statistics.store') }}" class="form-horizontal" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="pd-20 card-box mb-30">
                                    ...
                                    <div class="form-group row mt-3">
                                        ...
                                        <div class="col-sm-4 col-md-4">
                                            <input type="text" name="statistics_value" id="statistics_value" class="form-control @error('statistics_value') is-invalid @enderror" value="{{ old('statistics_value') }}" placeholder="Enter Statistics Value.">
